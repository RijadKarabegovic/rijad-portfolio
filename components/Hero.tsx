...
const Hero = () => {
    ...
    // Select the div or canvas where Spline is rendered
// const splineWrapper = document.querySelector('.spline-wrapper');

// // Disable scroll zoom (mouse wheel)
// splineWrapper.addEventListener('wheel', function(event) {
//   event.preventDefault();
// }, { passive: false });

// // Disable pinch zoom (touch devices)
// splineWrapper.addEventListener('touchmove', function(event) {
//   if (event.scale !== 1) {
//     event.preventDefault();
//   }
// }, { passive: false });
