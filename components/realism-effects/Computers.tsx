...
//     <ScreenInteractive hovered={hovered} setHovered={setHovered} frame="Object_206" panel="Object_207" position={[0.27, 1.53, -2.61]} scale={1.1}/>
//     <ScreenText hovered={hovered} frame="Object_218" panel="Object_219" y={2} position={[-1.23, 2.5, -1.8]} rotation={[0, 0.3, 0]} />
//     <ScreenText hovered={hovered} invert frame="Object_212" panel="Object_219" x={-5} y={2} position={[-2.73, 0.63, -0.52]} rotation={[0, 1.09, 0]} />
//     <ScreenText hovered={hovered} invert frame="Object_215" panel="Object_216" y={2.6} position={[1.84, 0.38, -1.77]} rotation={[0, -Math.PI / 9, 0]} />
//     <ScreenText hovered={hovered} invert frame="Object_218" panel="Object_219" x={-5} y={2} position={[3.11, 2.15, -0.18]} rotation={[0, -0.79, 0]} scale={1.4} />
//     <ScreenText hovered={hovered} invert frame="Object_221" panel="Object_219" y={1.6} position={[-3.42, 3.06, 1.3]} rotation={[0, 0.9, 0]} scale={1} />
//     <ScreenText hovered={hovered} invert frame="Object_224" panel="Object_219" y={2.4} position={[-3.9, 4.29, -2.64]} rotation={[0, 0.54, 0]} />
//     <ScreenText hovered={hovered} frame="Object_227" panel="Object_228" y={2.8} position={[0.96, 4.28, -4.2]} rotation={[0, -0.65, 0]} />
//     <ScreenText hovered={hovered} frame="Object_230" panel="Object_231" position={[4.68, 4.29, -1.56]} rotation={[0, -Math.PI / 3, 0]} />
//     <ScreenText hovered={hovered} invert frame="Object_209" panel="Object_219" y={1.4} position={[0.2, 3.21, -3.17]} rotation={[0, -0.2, 0]} />
//     <ScreenText hovered={hovered} frame="Object_212" panel="Object_219" x={-5} y={1.6} position={[2.12, 2.47, -3.04]} rotation={[0, -0.2, 0]} />
//     <ScreenText hovered={hovered} invert frame="Object_215" panel="Object_216" y={2.8} position={[-1.55, 3.72, -1.89]} rotation={[0, 0.3, 0]} />
//     <ScreenText hovered={hovered} invert frame="Object_218" panel="Object_219" x={-5} position={[3, 0.94, 2.47]} rotation={[0, -1, 0]} scale={1} />
//     <ScreenText hovered={hovered} invert frame="Object_221" panel="Object_219" y={1.4} position={[-2.68, 1.9, -1]} rotation={[0, 1, 0]} scale={1.2} />
//     <ScreenText hovered={hovered} invert frame="Object_224" panel="Object_225" y={2} position={[3.23, 4.32, -3.11]} rotation={[0, -0.5, 0]} scale={1.3} />
//     <ScreenText hovered={hovered} frame="Object_227" panel="Object_228" position={[-0.43, 0, -1.78]} rotation={[0, -0.65, 0]} scale={0.9}/>
//     <ScreenText hovered={hovered} frame="Object_218" panel="Object_219" x={-5} y={1.2} position={[2.5, 0.1, 0]} rotation={[0, -1, 0]} scale={0.75} />
//     <ScreenText hovered={hovered} frame="Object_230" panel="Object_231" position={[4.2, 2.9, 1.8]} rotation={[0, -1, 0]}/>
...
function ScreenInteractive(props) {
  return (
    <Screen {...props} >
      ...
      <SpinningBox href='http://localhost:3000/home' position={[-3.15, 0.75, 0]} scale={0.5} onHover={props.setHovered}  />
    </Screen>
  )
}